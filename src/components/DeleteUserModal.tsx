...
export default function DeleteUserModal({userId, onCloseAction}: DeleteUserModalProps) {
  ...
  return (
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div className="relative bg-white p-6 rounded-lg shadow-md w-full max-w-md">
          ...
          <p className="text-center text-gray-700 mb-6">Are you sure you want to delete this
            user?</p>
